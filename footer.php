...
<script data-no-instant src="<?php $this->options->themeUrl('js/SmoothScroll.js?v=1'); ?>"></script>
<?php endif;?>
<?php $this->options->tongji(); ?>

<script data-no-instant src="https://cdn.bootcss.com/instantclick/3.0.1/instantclick.js"></script>
<script data-no-instant>InstantClick.init();</script>
<script data-no-instant src="<?php $this->options->themeUrl('js/main.js?v=133'); ?>"></script>